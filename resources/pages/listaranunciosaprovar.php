...
<nav aria-label="breadcrumb" role="navigation">
  <ol class="breadcrumb bg-white">
    ...
    <li class="breadcrumb-item active">Listar anúncios por aprovar</li>
  </ol>
</nav>

<div class="container">
  <h2>Anúncios para Aprovar</h2>
  <div class="row">
    <!-- inicio do quarto 1-->
    <div class="col-lg-4 col-sm-6 portfolio-item">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p>Tipo de Alujamento: Apartamento<br>Nº de Quartos: 3<br>Sexo: Ambos<br><br></p>
          <div style="text-align: right;"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalanuncio1">Mais Informações</button></div>
        </div>
      </div>
    </div>
    <!--Fim do quarto 1-->
    ...
    <div class="col-lg-4 col-sm-6 portfolio-item">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <h6>Descrição Detalhada</h6>
          <p>Tipo de Alujamento: Casa<br>Nº de Quartos: 3<br>Sexo: Raparigas<br><br></p>
        ...
        <div class="modal-body">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="anuncio2quarto3" role="tabpanel">
              ...
              <h5>Observações:</h5><p>Quarto super modelado, para ricos ....</p>
            </div>
          </div>
        </div>
        <div class="modal-footer">
        ...
        <div class="modal-body">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="anuncio3quarto1" role="tabpanel">
              ...
              <img src="./img/room1.jpg" alt="quarto1" height="100%" width="100%">
              <h5>Renda:</h5><p>300 Euros</p>
              <h5>Observações:</h5><p>Quarto de Rei...</p>
            </div>
          </div>
        </div>
        <div class="modal-footer">
